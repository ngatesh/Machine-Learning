...
trainingData = dataGen.flow_from_directory("DogsCats/dogs-vs-cats/train", target_size=(64, 64), batch_size=32)
testingData = dataGen.flow_from_directory("DogsCats/dogs-vs-cats/test", target_size=(64, 64), batch_size=32)
...
history = model.fit(trainingData, steps_per_epoch=625, epochs=10, validation_data=testingData, validation_steps=156)
